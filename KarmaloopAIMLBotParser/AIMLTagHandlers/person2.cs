...
namespace KarmaloopAIMLBot.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person2 : KarmaloopAIMLBot.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person2(KarmaloopAIMLBot.AIMLBot bot,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person2")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return KarmaloopAIMLBot.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.Person2Substitutions, this.templateNode.InnerText);
                }
                else
                {
