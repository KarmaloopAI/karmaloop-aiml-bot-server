...
namespace KarmaloopAIMLBot.AIMLTagHandlers
{
    ...
    /// </summary>
    public class gender : KarmaloopAIMLBot.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public gender(KarmaloopAIMLBot.AIMLBot bot,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "gender")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return KarmaloopAIMLBot.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.GenderSubstitutions, this.templateNode.InnerText);
                }
                else
                {
